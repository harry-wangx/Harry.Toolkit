...
//    {
//        static IdCreator creator = null;

//        static IdHelper()
//        {
//            creator = new IdCreator(0, new DateTime(1970, 1, 1), TimeStampType.Millisecond, 12);
//        }

//        /// <summary>
//        /// 生成一个64位ID号(每实例每毫秒生成4096个,每天约可生成3,623,878亿个,自起始时间算起,可使用69年)
//        /// </summary>
